...
def main():
    ...
    for learning_rate in learning_rates:
        for batch_size in batch_sizes:
            ...
            # Automatically create a save directory based on script name + timestamp
            script_name = os.path.splitext(os.path.basename(__file__))[0]  # e.g., "train_4_classes_weighting_test"
            save_dir = f"{script_name}_{timestamp}_lr{learning_rate}_bs{batch_size}"
            ...
            # 🔁 Merge rare step counts (3, 4, 5 → 3)
