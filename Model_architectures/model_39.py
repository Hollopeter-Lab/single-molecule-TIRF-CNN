...
class StepDetectionCNN(nn.Module):
    def __init__(self, input_length=1000, num_classes=6):
        ...
        self.conv_layers = nn.Sequential(
            nn.Conv1d(1, 32, kernel_size=201, padding=100),
            nn.BatchNorm1d(32),
            nn.ReLU(),
            nn.MaxPool1d(2),
            
            nn.Conv1d(32, 64, kernel_size=101, padding=50),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(2),
            
            nn.Conv1d(64, 128, kernel_size=51, padding=25),
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.MaxPool1d(2),
        )
